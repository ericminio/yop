...
describe('server', () => {
    describe('port', () => {
        ...
        it('can be forced', async () => {
            secondServer = new Server(4999, (_, response) => {
            ...
            let answer = await fetch(`http://localhost:4999`);
            let content = await answer.text();
        ...
        it('welcomes default handler', async () => {
            secondServer = new Server(4990);
            await secondServer.start();
            let answer = await fetch(`http://localhost:4990`);
